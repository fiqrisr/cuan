...
└── packages/
    └── ui/         # Shared React component library (@cuan/ui, Radix UI, CVA, Tailwind CSS v4)
```
...
- **Shared UI (`packages/ui`)**: Shared React 19 design system and UI components package (`@cuan/ui`) bundled with **tsup**, built on **Radix UI**, **class-variance-authority** (CVA), and styled with **Tailwind CSS v4**.
