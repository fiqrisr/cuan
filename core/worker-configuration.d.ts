/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cc80e9b58911d760b0119aa08442f3dd)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 
export {};
declare global {
	const CLOUDFLARE_D1_BINDING_NAME: D1Database;
	const PORT: string;
	const BETTER_AUTH_SECRET: string;
	const BETTER_AUTH_URL: string;
	const LOG_LEVEL: string;
	const NODE_ENV: string;
	const CLOUDFLARE_ACCOUNT_ID: string;
	const CLOUDFLARE_DATABASE_ID: string;
	const CLOUDFLARE_D1_TOKEN: string;
	const AI_PROVIDER: string;
	const OPENMODEL_API_KEY: string;
	const OPENMODEL_BASE_URL: string;
	const OPENMODEL_MODEL: string;
