...
--> statement-breakpoint
INSERT INTO `__new_financial_accounts`("id", "user_id", "name", "type", "currency", "balance", "is_default", "created_at", "updated_at") SELECT "id", "user_id", "name", "type", "currency", "balance", "is_default", "created_at", "updated_at" FROM `financial_accounts`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_transactions`("id", "user_id", "account_id", "type", "amount", "currency", "category_id", "description", "date", "created_at", "updated_at") SELECT "id", "user_id", "account_id", "type", "amount", "currency", "category_id", "description", "date", "created_at", "updated_at" FROM `transactions`;--> statement-breakpoint
